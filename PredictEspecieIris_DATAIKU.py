...
# Model K Nearest Neighbors (k=5) (Modelo), trained on 2023-03-03 10:37:59.

# #### Generated on 2023-03-03 09:39:09.805597
...
get_ipython().magic('time _predictions = clf.predict(X_test)')
get_ipython().magic('time _probas = clf.predict_proba(X_test)')
